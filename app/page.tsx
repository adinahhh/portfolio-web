      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-2 sm:flex gap-2 sm:flex-wrap">
          ...
          <a
            ...
            className="text-sm text-ink border border-line rounded-md px-4 py-2 hover:bg-surface transition-colors flex items-center gap-2"
          >
          ...
          <a
            href="https://github.com/adinahhh"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-ink border border-line rounded-md px-4 py-2 hover:bg-surface transition-colors flex items-center gap-2"
          >
